/**
 * 🐉⚡ GOHAN BEAST - LID Resolver Module ⚡🐉
 * 
 * Resuelve identificadores LID (Linked ID) de WhatsApp a números de teléfono reales.
 * WhatsApp usa LIDs como identificadores opacos que pueden diferir de los números reales.
 * Este mapea los LIDs a los números de teléfono originales para que siempre se muestre
 * el número real del usuario en todo el bot.
 * 
 * Créditos:
 *   Autor original del script: YO SOY YO (The King Wilker)
 *   GitHub: https://github.com/Andresv27728
 *   Repositorio: https://github.com/dvwilker/Gohan-beast
 * 
 * Licencia: MIT
 */
